...
class FinalPitch extends Component {
                ...
                <div class="">
                    <div class="hacktitle-wrapper">
                        ...
                        <div class="hacktitle-inner-wrapper">
                            <div class="hackathon-title">{this.props.finalPitch.title}</div>

                            <div class="subheading">{this.props.finalPitch.description}</div>
                            <br />
...
const mapStateToProps = state => {
    return {
        finalPitch: state.otherEvents.finalPitch
    }
}

export default connect(mapStateToProps)(FinalPitch);
